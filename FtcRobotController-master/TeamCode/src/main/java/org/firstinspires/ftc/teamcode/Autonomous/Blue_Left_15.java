...
public class Blue_Left_15 extends org.firstinspires.ftc.teamcode.Autonomous.Auto_Base_15 {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        //moves away from wall, turns, scores on medium junction, and picks up new cone
        move(y, 0.1);
        moveElevator(2);
        turn(1);
        move(x, -2);
        ...
        //takes which parking spot the signal cone wants to be parked in (1 being the closest slot to the wall and 3 being the closest to the middle of the field)
        if (parkingSlot == 1) {
